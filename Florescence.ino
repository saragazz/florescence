// Florescense - Project 5 - "Portables"
// December 5, 2016
// A scarf designed using LED flowers that brighten up as it gets darker using a photoresistor
// Designed by Samaa Ahmed, and Ania Medrik


const int sensorPin = A5;
const int ledPin = 6;

// variables for the light level
...
void manualTune()
{
  ...
  lightLevel = map(lightLevel, 800, 300, 0, 255);
  lightLevel = constrain(lightLevel, 0, 255);
